...
const Toggle = () => {
  const [selectedContent, setSelectedContent] = useState(
    <>
      ...
      <span className='span'>Benefits:-</span>
      <div className='split'>
  ...
  return (
    <>
    <div>
    <h4 style={{ paddingLeft: '30px', marginTop:'50px' }}>More details about all the <span style={{color:'#ff8360'}}>PROGRAMS</span></h4>
   ...
   <p>Maths Topper,  Develop Intelligence,  Faster Calculation,  Improves Memory,  Lateral Thinking, Improves self Confidence,
    Creativity, Great Mental Agility, Problem Solving Ability.</p>
      ...
      <div className='benefit'>
      <span className='span'>Topics:-</span>
      <div className='split'>
